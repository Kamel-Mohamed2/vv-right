  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        orangeColor: "#FF5722",
        secondaryColor: "#1A1A1A", // Replace with your actual hex code
        mutedOrange: "#FFCCBC", // Replace with your actual hex code
        grayColor: "#9E9E9E", // Replace with your actual hex code
      },
      spacing: {
        3.75: "15px",
        7.5: "30px",
